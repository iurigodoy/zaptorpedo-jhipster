...
/**
 * REST controller for managing {@link br.com.zaptorpedo.domain.Message}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Message> result = messageRepository
            ...
            .map(
                existingMessage -> {
                    ...
                    if (message.getDestinyPhoneNumber() != null) {
                        existingMessage.setDestinyPhoneNumber(message.getDestinyPhoneNumber());
                    }
